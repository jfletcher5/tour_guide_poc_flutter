...
import 'expanding_f_a_b_model.dart';
export 'expanding_f_a_b_model.dart';

class ExpandingFABWidget extends StatefulWidget {
  const ExpandingFABWidget({super.key});
...
class _ExpandingFABWidgetState extends State<ExpandingFABWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExpandingFABModel());
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 2.0, 0.0),
                    child: Column(
